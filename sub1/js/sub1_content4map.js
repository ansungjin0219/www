 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.5216, 126.9191),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.5216, 126.9191); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.3628, 126.9317),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.3628, 126.9317); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.5659, 126.9956),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.5659, 126.9956); 
   ...
   var overlay3 = new daum.maps.CustomOverlay({
    ...
    //네번째 맵
     ...
     var container4 = document.getElementById('map_content4');
   var options4 = {
       center: new daum.maps.LatLng(37.5659, 126.9956),
       level: 2
   };
   ...
   var markerPosition4  = new daum.maps.LatLng(37.5659, 126.9956); 
